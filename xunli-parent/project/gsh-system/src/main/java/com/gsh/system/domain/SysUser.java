 ...
 * @author gsh
 */
@Id2NameClass(idCol = {"user_id","login_name"}, nameCol = "user_name", table = "sys_user", condition = "status = '0'")
public class SysUser extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 用户ID */
    //@Excel(name = "用户序号", cellType = ColumnType.NUMERIC, prompt = "用户编号") //userId允许用户自行输入
    private Long userId;
    ...
    /** 状态：0正常，1审核，2异常 */
    @Excel(name = "状态：'normal'正常，1审核，0异常")
    ...
    /** 迁移SysFactoryUser 特有字段 start*/
    /** 微信昵称 */
    @Excel(name = "微信昵称")
    private String wechatName;
    /** 迁移SysFactoryUser 特有字段 end*/
