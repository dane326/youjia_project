...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public List<Ztree> initZtree(List<SysDept> deptList, List<String> roleDeptList)
    {
        ...
        for (SysDept dept : deptList)
        {
            if (UserConstants.DEPT_NORMAL.equals(dept.getStatus()))
            {
                ...
                ztree.setKey(String.valueOf(dept.getFactoryCode()) + "|" + String.valueOf(dept.getDeptId()));
                ztree.setValue(dept.getDeptName());
    ...
    public int insertDept(SysDept dept)
    {
        ...
        dept.setFactoryCode(info.getFactoryCode());
        //这里注释掉
       /* if(dept.getParentId() == FactoryConfig.getDeptRootId()){
            //新增系统资料
    ...
    public int updateDept(SysDept dept)
    {
        ...
        {
            String newAncestors = "" + newParentDept.getDeptId();
            if(StringUtils.isNotBlank(newParentDept.getAncestors())){
    ...
    @Override
    public List<SysDept> selectAllChildDept(SysDept parentDept) {
        return deptMapper.selectAllChildDept(parentDept.getDeptId());
    }
}
