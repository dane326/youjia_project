package com.gsh.web.controller.demo.controller;
...
public class DemoFormController
{
     ...
     */
    @GetMapping("/bootstro")
    public String bootstro()
    {
        return prefix + "/bootstro";
    }
    ...
    {
        String[] array = { "gsh 1", "gsh 2", "gsh 3", "gsh 4", "gsh 5" };
        AjaxResult ajax = new AjaxResult();
     ...
     */
    @GetMapping("/exdtree")
    public String exdtree()
    {
        return prefix + "/exdtree";
    }
     ...
     * 自定义扩展select示例
     */
    @GetMapping("/exdselect")
    public String exdselect(HttpServletRequest request)
    {
        request.setAttribute("radiovalue","test");
        request.setAttribute("checkboxvalue","test,demo,demand");
        return prefix + "/exdselect";
    }

    /**
     * 自定义组织字典扩展select示例
     */
    @GetMapping("/factorydict")
    public String exdfactorydictselect(HttpServletRequest request)
    {
        request.setAttribute("radiovalue","test");
        request.setAttribute("checkboxvalue","test,demo,demand");
        return prefix + "/factorydict";
    }
