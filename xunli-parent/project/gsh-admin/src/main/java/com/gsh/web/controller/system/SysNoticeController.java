...
import com.gsh.system.domain.SysNotice;
import com.gsh.system.domain.SysUser;
import com.gsh.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController
{
    ...
    {
        SysUser user = ShiroUtils.getSysUser();    //获取当前账号信息
    ...
    {
        SysUser user = ShiroUtils.getSysUser();    //获取当前账号信息
        notice.setUpdateBy(user.getLoginName());
