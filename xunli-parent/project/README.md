...
## parent工程开发和打包步骤 ##
1. 打开项目新增或修改功能；
2. 利用**admin**模块下的启动类**GshApplication**启动项目调试功能!<br>
![](https://182.151.199.4:11158/prod-core/xunli-parent/raw/feature-xrl/project/img/project.png?inline=false)
3. 调试完成修改，在工程中全局替换版本号<br>
4. 双击项目下**bin/package.bat**打包打包后的文件在**admin**模块下的**target/lib**下；<br>
![](https://182.151.199.4:11158/prod-core/xunli-parent/raw/feature-xrl/project/img/package.png?inline=false)
5. 双击**target/lib**文件加下的deploy.bat完成上传<br>
![](https://182.151.199.4:11158/prod-core/xunli-parent/raw/feature-xrl/project/img/deploy.png?inline=false)
6. 在引用的工程中修改改成上传的parent的版本号测试；
